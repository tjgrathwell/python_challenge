bigmess = "kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT\
...
expression = re.compile("[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]")
endstring = ""

for result in expression.findall(bigmess):
  endstring = endstring + result[4]
print endstring